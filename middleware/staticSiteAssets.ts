...
const staticAssetspackageName =
  ...
  defaultPublicAssetsPackageName;
...
export function StaticSiteFavIcon(app) {
  try {
    ...
    console.error(
      `The static site assets in "${ospoAssetsDistPath}" does not include a favicon. You may need to run 'npm install' in the package folder first.`
    );
    throw nofavicon;
  }
}
